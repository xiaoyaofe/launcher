...
```js
import Modal from 'src/bower/material-ui/packages/material-ui/src/Modal';
```
...
| <span class="prop-name">manager</span> | <span class="prop-type">object</span> | <span class="prop-default">new ModalManager()</span> | A modal manager used to track and manage the state of open Modals. This enables customizing how modals interact within a container. |
