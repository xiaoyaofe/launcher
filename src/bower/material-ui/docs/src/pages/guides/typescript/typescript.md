...
import { Breakpoint } from 'src/bower/material-ui/packages/material-ui/src/styles/createBreakpoints';

declare module 'src/bower/material-ui/packages/material-ui/src/styles/createMuiTheme' {
  interface Theme {
    appDrawer: {
...
```ts
import createMuiTheme, { ThemeOptions } from 'src/bower/material-ui/packages/material-ui/src/styles/createMuiTheme';
