...
```diff
-import CircularProgress from 'src/bower/material-ui/packages/material-ui/src/Progress/CircularProgress';
+import CircularProgress from 'src/bower/material-ui/packages/material-ui/src/CircularProgress';
```

```diff
-import { ListItem } from 'src/bower/material-ui/packages/material-ui/src/List';
